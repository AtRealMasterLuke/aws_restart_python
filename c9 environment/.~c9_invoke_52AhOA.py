# getDoubleAlphabet that takes a string argument and concatenates
def getDoubleAlphabet(alphabet):
    doubleAlphabet = alphabet + alphabet
    return doubleAlphabet
print(getDoubleAlphabet("ABC"))

# request a message to encrypt from the user
def getMessage():
    stringToEncrypt = input("Please enter a message to encrypt: ")
    return stringToEncrypt

#  function to request a cipher key from the user
def getCipherKey():
...
# Decrypting the message: undo the encryption by shifting each letter back. 
